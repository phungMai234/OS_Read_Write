...
public class banker {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("n(process): ");
        number_of_process = myObj.nextInt();
        System.out.println("n(process): " + number_of_process);
        int number_of_resources;
        System.out.print("m(sources): ");
        number_of_resources = myObj.nextInt();
        System.out.println("m(sources): " + number_of_resources);
        int[] available = new int[number_of_resources];
        System.out.print("Available: ");
        for (int i = 0; i < number_of_resources; i++) {
            available[i] = myObj.nextInt();
        }
        System.out.print("List allocation: ");
